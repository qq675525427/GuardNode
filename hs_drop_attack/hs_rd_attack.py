...
parser.add_argument('--chutneynodepath', type=str,
                    help="Base dir of the network (~?chutney/net/nodes[timestamp]/). The private network should already be up and running")
...
class HS_rd_attack():
    ...
    def __init__(self, process, onionaddr_file, nbr_circs, t_until):
        ...
        process.tor_protocol.add_event_listener('HS_ATTACK_MONITOR_HEALTHINESS',
                                                self.monitor_attack_healthiness_callback)
